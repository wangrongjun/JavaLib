 ...
 * <p>
 * http://www.runoob.com/http/http-content-type.html - HTTP content-type _ 菜鸟教程
 * <p>
 * $(function (){
 * // map.put("a", "b");
 * var bool=true;
 * var s="";
 * $(".reference td").each(function(index,element){
 * if(bool){
 * s+="map.put(\""+$(element).text()+"\",\"";
 * }else{
 * s+=$(element).text()+"\");<br>";
 * }
 * bool=!bool;
...
public class ContentType {
    ...
    private static void initMap() {
        map.put(".*", "application/octet-stream");//  二进制流，不知道下载文件类型
