package com.wangrj.java_lib.java_program.student_manage_system.view;

import com.wangrj.java_lib.java_program.student_manage_system.contract.StudentMainContract;
import com.wangrj.java_lib.java_program.student_manage_system.controller.StudentMainController;
import com.wangrj.java_lib.swing.JTabbedPaneUtil;
import com.wangrj.java_lib.java_program.student_manage_system.view.base.BaseView;
import com.wangrj.java_lib.java_program.student_manage_system.view.tab.StudentCoursePanel;
import com.wangrj.java_lib.java_program.student_manage_system.view.tab.StudentInfoPanel;
import com.wangrj.java_lib.java_program.student_manage_system.view.tab.StudentSelectedCoursePanel;
...
public class StudentMainView extends BaseView implements StudentMainContract.IStudentMainView {
    ...
    public StudentMainView() {
        controller = new StudentMainController(this);// TODO Spring
    }
    ...
    private void initTree() {
        ...
        DefaultMutableTreeNode root = new DefaultMutableTreeNode("查询");
        root.add(userNode);
        root.add(courseNode);
        root.add(scNode);
        tree = new JTree(root);
    ...
    public void closeAndOpenLoginView(Class viewClass, String account, String password) {
        ...
        try {
            ...
            LoginView.identity = 0;// 这里强耦合也没关系
