...
//                            innerIdField.set(innerEntity, innerIdValue);
                            ...
                            com.wangrj.java_lib.db2.Query query = com.wangrj.java_lib.db2.Query.where(Where.eq(innerIdName, innerIdValue + ""));
    ...
    @Override
    public List<T> query(com.wangrj.java_lib.db2.Query query) {
    ...
    public List<T> query(Where where) {
        return query(com.wangrj.java_lib.db2.Query.where(where));
    }
    ...
    public List<T> queryAll() {
        return query(new com.wangrj.java_lib.db2.Query());
    }
