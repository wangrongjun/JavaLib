 ...
 * 3.页面显示学生课程列表：view.showCourseList(List courseList,int currentPageIndex,int totalPageCount)
 * <p>
 * 1.学生点击选课按钮：controller.clickSelectCourse(long courseId)
 */
public interface StudentCourseContract {
    ...
    interface IStudentCourseController extends BaseContract.IBaseController {
        void clickShowCourseList(int pageIndex);

        void clickRefreshCourseList();
