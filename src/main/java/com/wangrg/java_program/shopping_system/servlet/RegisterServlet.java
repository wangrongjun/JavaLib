...
public class RegisterServlet extends CustomHttpServlet {
    ...
    private com.wangrg.java_program.shopping_system.Response<String> response;
    ...
    protected void onGetParameterFinish(HashMap parameterMap) {
        ...
        try {
            ...
            if (userDao.query(phone) != null) {
                response = new com.wangrg.java_program.shopping_system.Response<>(com.wangrg.java_program.shopping_system.StateCode.ERROR_NORMAL, "���ֻ�����ע��");
            } else {
                com.wangrg.java_program.shopping_system.bean.User user = new com.wangrg.java_program.shopping_system.bean.User(phone, password, null, null, 0);
                userDao.insert(user);
                response = new com.wangrg.java_program.shopping_system.Response<>(com.wangrg.java_program.shopping_system.StateCode.OK, "ע��ɹ�");
            }
