...
public class LoginServlet extends CustomHttpServlet {
    ...
    private com.wangrg.java_lib.java_program.shopping_system.Response<User> response;
...
//    @Override
    protected void onGetParameterFinish(HashMap parameterMap) {
        ...
        try {
            ...
            if (user != null) {
                response = new com.wangrg.java_lib.java_program.shopping_system.Response<>(com.wangrg.java_lib.java_program.shopping_system.StateCode.OK, user, null);
            } else {
                response = new com.wangrg.java_lib.java_program.shopping_system.Response<>(com.wangrg.java_lib.java_program.shopping_system.StateCode.ERROR_NORMAL, "�ֻ��Ų����ڻ��������");
            }
        } catch (Exception e) {
            e.printStackTrace();
