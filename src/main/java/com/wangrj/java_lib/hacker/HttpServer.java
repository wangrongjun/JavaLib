package com.wangrj.java_lib.hacker;
...
public class HttpServer {
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        httpServer.GET("http://192.168.199.245");
//        int i;
//        for (i = 0; i < 50000; i++) {
//            httpServer.GET("http://www.model-dl.com/modelinfo.asp?modelid=101");
//            httpServer.POST("http://www.model-dl.com/modelinfo.asp?modelid=101", "ratecontd = 101 & MM_insert = form1");
//        }
    }
}
