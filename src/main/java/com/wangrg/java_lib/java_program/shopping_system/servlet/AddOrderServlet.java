...
public class AddOrderServlet extends CustomHttpServlet {
    ...
    private com.wangrg.java_lib.java_program.shopping_system.Response<Orders> response;
...
//    @Override
    protected void onGetParameterFinish(HashMap parameterMap) {
        ...
        try {
            ...
            e.printStackTrace();
            response = new com.wangrg.java_lib.java_program.shopping_system.Response<>(com.wangrg.java_lib.java_program.shopping_system.StateCode.PARAM_ERROR, "����������");
            return;
        }
        ...
        try {
            ...
            response = new com.wangrg.java_lib.java_program.shopping_system.Response<>(com.wangrg.java_lib.java_program.shopping_system.StateCode.OK, order, null);
        } catch (Exception e) {
            e.printStackTrace();
